...
var RoomPage = React.createClass({displayName: "RoomPage",
    ...
    setupEvents: function () {
        ...
        eventbus.on("edit-room", function () {
            if (_.contains(component.state.room.admins, component.state.user.id)) {
                router.showModal(React.createElement(RoomEdit, {room: component.state.room}));
            }
            else {
    ...
    render: function () {
        ...
        if (!this.state.room.name) {
            emptyPlaylistMessage = React.createElement("div", null, "Loading...");
        }
        else if (this.state.room.tracks.length < 2) {
            emptyPlaylistMessage = React.createElement("div", null, "Drag and drop a few tracks from Spotify to get started. ");
        }

        if (_.isEmpty(this.state.room.name)) {
            return React.createElement("div", null, 
                React.createElement("div", {className: "panel panel-room-top panel-success"}, 
                    React.createElement("div", {className: "panel-heading", style: {backgroundColor: this.props.color}})
                ), 
       ...
       /* var roomImageStyle = {};
        ...
        {
            moreResultsButton = React.createElement("div", null, React.createElement("div", {className: "list-group-separator"}), React.createElement("div", {className: "row-content", style: {marginLeft:72}}, React.createElement("div", {className: "list-group-item", onClick: component.clickMoreResults, style: {cursor:'pointer'}}, React.createElement("h4", {className: "list-group-item-heading"}, "More results..."))));
        }
        ...
        return (
            React.createElement("div", {id: "room", onDrop: this.handleDrop, onDragOver: this.dragOver, onDragEnter: this.dragOver, onKeyDown: this.handleKeyDown}, 
                ...
                React.createElement("div", {id: "playlistcontainer", className: this.state.room.tracks.length == 0 ? "no-now-playing" : ""}, 
                    React.createElement("div", {className: "container-fluid"}, 
                        React.createElement("div", {className: "playlistpadder"}, 
                            React.createElement("div", {className: "row"}, 
                                React.createElement("div", {className: "form-control-wrapper track-search-container"}, 
                                ...
                                React.createElement("div", {className: "playlist", style: {display: tracksForRoomPlaylist.length == 0 ? "none" : "block"}}, 
                                    ...
                                    React.createElement("div", {className: "list-group play-list-group"}, 
                                          this.state.room.tracks.map(function (track, index, arr) {
                                              ...
                                              return React.createElement(PlaylistItem, {
                                                  track: track, 
                                                  key: track.id, 
                                    ...
                                    React.createElement("div", {className: "playlist"}, 
                                        ...
                                        React.createElement("div", {className: "list-group"}, 
                                              _.filter(component.state.spotifySearchResults, function (t) {
                                                  ...
                                                  return React.createElement(PlaylistItem, {track: track, key: track.id, color: component.state.room.color, canVote: false, canAdd: true, isLast: index == arr.length - 1, visible: true})
                                              }), 
                ...
                React.createElement(ChatPanel, {chat: this.state.room.chat, color: this.state.room.color, user: this.state.user, tracks: this.state.room.tracks}), 

                React.createElement("div", {className: "panel panel-room-top panel-success", style: {backgroundColor:'transparent !important'}}, 
                    React.createElement("div", {className: "panel-heading", style: {backgroundColor: this.convertHexColor(this.state.room.color, 80)}}, 
                        React.createElement("div", {className: "container-fluid"}, 
                            React.createElement("div", {className: "row"}, 
                                React.createElement("div", {className: "col-xs-12"}, 
                                    React.createElement("div", {className: "play-pause-container pull-left"}, 
                                        React.createElement("a", {href: "javascript:void(0)", onClick: this.onClickPlayPause, className: 'btn btn-fab btn-success btn-pause-play ' + (this.state.playing ? 'mdi-av-pause' : 'mdi-av-play-arrow'), style: {color: this.state.room.color}}, " ")
                                    ), 
                                    React.createElement("div", null, 
                                        React.createElement("h2", {className: "hide-overflow room-name"}, 
                                        this.state.room.name

                                        ), 
                                        React.createElement("p", {className: "hide-overflow", style: {marginLeft: '30px', lineHeight: '40px;'}}, 
                                            React.createElement("span", {className: "playlist-state", "data-toggle": "tooltip", "data-placement": "bottom", title: "", "data-original-title": this.state.room.locked ? "Playlist is closed. <br/> You may vote up curated tracks." : "Playlist is open. <br/>Search for tracks below, or <br/>drag and drop from Spotify.", "data-html": "true"}, 
                                                React.createElement("i", {className: '' + (this.state.room.locked ? "mdi-action-lock-outline" : "mdi-av-playlist-add")})
                                            ), 
                                            React.createElement("span", {className: "room-track-count ", "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Tracks queued", "data-delay": "0"}, 
                                                this.state.room.tracks.length, 
                                                React.createElement("i", {className: "mdi-av-album"})
                                            ), 
                                            React.createElement("span", {className: "room-listeners ", onClick: this.toggleUserListClick, "data-toggle": "tooltip", "data-placement": "top", title: "", "data-original-title": "Show listeners", "data-delay": "0"}, this.state.room.listeners.length, 
                                                React.createElement("i", {className: "mdi-social-person"})
                                            ), 

                                            React.createElement("span", {className: "room-youtube", onClick: this.onClickYoutube, "data-toggle": "tooltip", "data-placement": "top", title: "", "data-original-title": "View on YouTube (alpha)", "data-delay": "0"}, 
                                                React.createElement("i", {className: "mdi-hardware-desktop-windows"})
                                            ), 

                                            React.createElement("span", {className: "room-description"}, 
                ...
                React.createElement("div", {className: "userlist"}, 
                    React.createElement("ul", {className: "list-group"}, 
                            this.state.room.listeners.map(function (user,index,arr) {
                                return React.createElement("li", {className: "list-group-item userentry"}, 
                                    React.createElement("div", null, 
                                        React.createElement("img", {className: "useravatar", src: user.img, onClick: component.openSpotifyProfile.bind(component, user.spotifyUsername)}), 
                    ...
                    React.createElement("i", {className: "mdi-navigation-close userlist-close pull-right", onClick: this.toggleUserListClick})
